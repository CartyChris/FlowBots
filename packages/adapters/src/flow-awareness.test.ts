...
describe("shared Flow awareness", () => {
  ...
  it("builds a same-user connected roster and excludes isolated teammates", () => {
    const roster = buildFlowRoster({ id: "bottie", name: "Bottie", instructions: "" }, [
      {
        id: "bottie",
        name: "Bottie",
        title: "Coordinator",
  ...
  it("gives an isolated source no automatic teammate roster", () => {
    ...
    const roster = buildFlowRoster({ id: "solo", name: "Solo", instructions: sourceInstructions }, [
      { id: "solo", name: "Solo", title: "", description: "", instructions: sourceInstructions },
      {
        id: "susie",
        name: "Susie",
        title: "Builder",
        description: "Makes apps.",
        instructions: "",
      },
    ]);
