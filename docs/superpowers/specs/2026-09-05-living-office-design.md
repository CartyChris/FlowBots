...
6. Prefer bounded data queries and CSS motion; no model calls for visuals, routing or social expression. Preserve reduced motion. No GPU dependencies in ordinary operation.
